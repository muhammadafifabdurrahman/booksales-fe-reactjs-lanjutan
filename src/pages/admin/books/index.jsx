...
export default function AdminBooks() {
  ...
  useEffect(() => {
    {
      /**kode const fetchData akan menjalan kode setelahnya no 12 */
    }
        ...
        <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
          ...
          >
            ...
            <ul className="inline-flex items-stretch -space-x-px">
              ...
              <li>
                <Link to={"#"} className="flex items-center justify-center text-sm z-10 py-2 px-3 leading-tight text-indigo-600 bg-indigo-50 border border-indigo-300 hover:bg-indigo-100 hover:text-indigo-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white">
                3
                </Link>
              </li>
              <li>
